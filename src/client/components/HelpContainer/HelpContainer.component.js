...
export class HelpContainerComponent extends Component {
  proHelp() {
    if (this.props.pro) {
    return <div className='help-pro--container'>
             <a name="supplNumbers"/>
             ...
             <div className="section">
               ...
               <div><div className="bullet">4</div>Romaner og noveller. Antologier
                 <div className="note">
                   ...
                   I grupperne 86 og 88 placerer Dansk bogfortegnelse l&aelig;seb&oslash;ger og prosaantologier til skolebrug i en undergruppe med till&aelig;gstallet -046 eller -246.
